...
class EditClassSheet extends StatefulWidget {
  ...
  const EditClassSheet({super.key, required this.mClassObj});
...
class _EditClassSheetState extends State<EditClassSheet> {
  ...
  void _btnCreate(BuildContext ctx) async {
    ...
    print("Changed? $changedBanner");

    final classModel = ClassModel(
      id: widget.mClassObj.id,
      name: _titleTF.text,
      school: _schoolTF.text,
      color: currentColor.toARGB32(),
      banner: changedBanner ? selectedBannerFile : null,
    );

    print(selectedBannerFile?.path);
    print("Calling with");
    print(classModel);

    final MinimalClassModel? classCreated =
        await classManagementViewModel.editClass(classModel);
  ...
  @override void initState() {
    ...
    _titleTF.text = widget.mClassObj.name;
    _schoolTF.text = widget.mClassObj.school;
    currentColor = Color(widget.mClassObj.color);
                              ...
                              SizedBox(
                                ...
                                child: AspectRatio(
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    child: (widget.mClassObj.bannerUrl != null || selectedBanner != null)
                                        ? Container(
                                            decoration: BoxDecoration(
                                              ...
                                              image: DecorationImage(
                                                image:
                                                    changedBanner ? MemoryImage(selectedBanner!) : NetworkImage(widget.mClassObj.bannerUrl!),
                                                fit: BoxFit.cover,
                                              ),
                                            ),
                                          )
